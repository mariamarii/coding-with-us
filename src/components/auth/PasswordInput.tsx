      ...
      <div>
        ...
        <div className="relative">
          <Input
            ...
            ref={ref}
            className={`w-full px-3 py-2 pr-10 border bg-white border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#76B729] focus:border-[#76B729] ${className || ''}`}
            {...props}
          />
          <button
            type="button"
