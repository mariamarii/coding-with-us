...
export function CourseEnrollmentCard({
  ...
  return (
    <Card className={cn( " relative w-full max-w-xs mx-auto xl:max-w-[280px] xl:w-[280px] bg-[#F1F8EA] rounded-lg shadow-lg overflow-hidden", className)}>
      <VideoPreview 
          ...
          <Button onClick={onShare} className="p-0 bg-transparent shadow-none hover:bg-transparent hover:opacity-75">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6">
              ...
              <path d="M10.1094 13.6501L13.6894 10.0601" stroke="#76B729" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <Button className=" absolute z-50 p-0 border-none  -right-0 -bottom-0 w-12 h-12 sm:w-14 sm:h-14 bg-[#76b729] hover:bg-[#5a8f1f] text-white rounded-full shadow-lg flex items-center justify-center transition-colors ">
